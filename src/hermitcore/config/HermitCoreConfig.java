...
public final class HermitCoreConfig 
{
	...
	public static void init(File configFile)
	{
		...
		try
		{
			...
			recordName = config.get("recordNames", "customRecords", new String[] {"Depth"}, "on new line put name of song Ex: For Pingu Trap Remix, PinguTrap").getStringList();
			recordURL = config.get("recordURLs", "customRecords", new String[] {"http://hc-exploration.cu.cc/version/Depth.ogg"}, "On new line put download link for an ogg sound file").getStringList();
